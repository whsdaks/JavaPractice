...
<nav aria-label="Page navigation">
  <ul class="pagination">
    <li ${page.pageNum == 1 ? 'class="disabled"' : '' }>
      <a href="user_list?page=${page.pageNum-1 < 1 ? 1 : page.pageNum -1 }" aria-label="Previous">
    ...
    <c:forEach begin="${page.pageNum - 2 < 1 ? 1 : page.pageNum - 2 }" 
    	...
    	<li ${page.pageNum == num ? 'class="active"' : '' }>
    		<a href="/user_list?page=${num }">${num }</a>
    	</li>
    </c:forEach>
    <li ${page.pageNum == page.pages ? 'class="disabled"' : '' }>
      <a href="user_list?page=${page.pageNum + 1 > page.pages ? page.pages : page.pageNum + 1 }" aria-label="Next">
